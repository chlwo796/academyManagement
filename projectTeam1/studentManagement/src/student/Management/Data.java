...
public class Data {
	...
	public List<Student> getStudentList() {
		...
		studentList.add(new Student("박정은", "010-2222-2222", "2반", "수학"));
		studentList.add(new Student("오성철", "010-3333-3333", "1반", "영어"));
		studentList.add(new Student("최재환", "010-4444-4444", "2반", "수학"));
		studentList.add(new Student("박정은", "010-1111-2222", "1반", "국어"));
		studentList.add(new Student("박재민", "010-5555-5555", "1반", "영어"));
		studentList.add(new Student("김유진", "010-6666-6666", "2반", "국어"));
		studentList.add(new Student("이민아", "010-7777-7777", "1반", "수학"));
		studentList.add(new Student("최윤우", "010-8888-8888", "1반", "영어"));
		studentList.add(new Student("임지수", "010-9999-9999", "1반", "수학"));
		studentList.add(new Student("황성준", "010-0000-0000", "2반", "국어"));
	...
	public TreeMap<Student, Score> getScoreMap() {
		...
		scoreMap.put(new Student("최윤우", "010-8888-8888", "1반", "영어"), new Score(88));
		scoreMap.put(new Student("임지수", "010-9999-9999", "1반", "수학"), new Score(65));
		scoreMap.put(new Student("황성준", "010-0000-0000", "2반", "국어"), new Score(65));
	...
	public TreeMap<Student, AttendanceData> getAttendanceMap() {
		...
		attendanceMap.put(new Student("이민아", "010-7777-7777", "1반", "수학"), new AttendanceData(0));
		attendanceMap.put(new Student("최윤우", "010-8888-8888", "1반", "영어"), new AttendanceData(1));
		attendanceMap.put(new Student("임지수", "010-9999-9999", "1반", "수학"), new AttendanceData(1));
		attendanceMap.put(new Student("황성준", "010-0000-0000", "2반", "국어"), new AttendanceData(1));
