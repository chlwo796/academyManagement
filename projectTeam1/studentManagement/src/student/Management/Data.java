...
public class Data {
	...
	public TreeMap<Student, Score> getScoreMap() {
		...
		scoreMap.put(new Student("유관순2", "010-4444-4444", "2반", "수학"), new Score(59));
		scoreMap.put(new Student("유관순3", "010-1111-1111", "1반", "국어"), new Score(79));
		scoreMap.put(new Student("유관순4", "010-5555-5555", "1반", "영어"), new Score(90));
		scoreMap.put(new Student("유관순5", "010-6666-6666", "2반", "국어"), new Score(98));
