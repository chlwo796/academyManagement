...
public class Data {
	...
	public List<Student> getStudentList() {
		...
		studentList.add(new Student("유관순2", "010-3333-3333", "2반", "수학"));
		studentList.add(new Student("유관순3", "010-3333-3333", "1반", "국어"));
		studentList.add(new Student("유관순4", "010-3333-3333", "1반", "영어"));
		studentList.add(new Student("유관순5", "010-3333-3333", "2반", "국어"));
		studentList.add(new Student("유관순6", "010-3333-3333", "1반", "수학"));
		studentList.add(new Student("유관순7", "010-3333-3333", "1반", "수학"));
		studentList.add(new Student("유관순8", "010-3333-3333", "1반", "수학"));
